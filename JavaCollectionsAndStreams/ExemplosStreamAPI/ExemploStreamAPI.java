...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        // Exibe cada elemento no console semretornar outra coleção
        System.out.println("Retorna os elementos novamente: ");
        estudantes.stream().forEach(System.out::println);

        // Retorna true se todos os elementos possuem a letra R no nome
        System.out.println("Todos os elementos contém R no nome?" + estudantes.stream().allMatch((elemento) ->
                elemento.contains("r")));

        // Retorna true se algum dos elementos possuirem a letra a minúscula no nome
